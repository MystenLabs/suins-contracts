...
module suins::helper_tests {
    ...
    fun test_string_to_number() {
        assert!(helper::string_to_number(utf8(b"1234")) == 1234, 0);
        assert!(helper::string_to_number(utf8(b"0")) == 0, 0);
        assert!(helper::string_to_number(utf8(b"18446744073709551615")) == 18446744073709551615, 0);
    }

    #[test, expected_failure(abort_code = helper::EInvalidNumber)]
    fun test_string_to_number_abort_if_NAN() {
        helper::string_to_number(utf8(b"a"));
    }
}
