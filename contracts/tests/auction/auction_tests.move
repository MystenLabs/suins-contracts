...
module suins::auction_tests {
    ...
    use suins::auction::{Self, Auction, make_seal_bid, get_seal_bid_by_bidder, finalize_auction, get_bids_by_bidder, get_bid_detail_fields, withdraw, state, finalize_auction_by_admin, finalize_all_auctions_by_admin};
    ...
    fun test_bids_multiple_times_same_domain_and_same_highest_value_then_finalize() {
        ...
        let seal_bid = make_seal_bid(NODE, FIRST_USER_ADDRESS, 2000, FIRST_SECRET);
        place_bid_util(scenario, seal_bid, 3300, FIRST_USER_ADDRESS);
