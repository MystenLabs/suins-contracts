...
module suins::auction_tests_4 {
    ...
    #[test]
        ...
        place_bid_util(scenario, seal_bid, 12200 * config::mist_per_sui(), SECOND_USER_ADDRESS, 0, option::none(), 15);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin1) == 300 * config::mist_per_sui(), 0);

            assert!(auction::get_balance(&auction) == 12200 * config::mist_per_sui(), 0);
            assert!(
                suins::balance(&suins) == START_AN_AUCTION_FEE + 1000 * config::mist_per_sui() + BIDDING_FEE * 2,
                0
            );
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin) == 12200 * config::mist_per_sui(), 0);
            ...
            assert!(suins::balance(&suins) == START_AN_AUCTION_FEE + 1000 * config::mist_per_sui() + BIDDING_FEE * 2, 0);
    ...
    fun test_finalize_all_auctions_by_admin_not_affect_non_revealed_bids() {
        ...
        place_bid_util(scenario, seal_bid, 12200 * config::mist_per_sui(), FIRST_USER_ADDRESS, 0, option::none(), 15);
        let seal_bid = make_seal_bid(FIRST_DOMAIN_NAME, FIRST_USER_ADDRESS, 3000 * config::mist_per_sui(), FIRST_SECRET);
        place_bid_util(scenario, seal_bid, 10200 * config::mist_per_sui(), FIRST_USER_ADDRESS, 0, option::none(), 20);
        ...
        test_scenario::next_tx(scenario, SUINS_ADDRESS);
        {
            ...
            get_entry_util(&mut auction, FIRST_DOMAIN_NAME, START_AN_AUCTION_AT + 1, 3000 * config::mist_per_sui(), 0, FIRST_USER_ADDRESS, false);
            finalize_all_auctions_by_admin(
                &admin_cap,
                &mut auction,
                &mut suins,
            ...
            get_entry_util(&mut auction, FIRST_DOMAIN_NAME, START_AN_AUCTION_AT + 1, 3000 * config::mist_per_sui(), 0, FIRST_USER_ADDRESS, true);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            let coin1 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin1) == 7200 * config::mist_per_sui(), 0);

            assert!(auction::get_balance(&auction) == 13500 * config::mist_per_sui(), 0);
            assert!(suins::balance(&suins) == START_AN_AUCTION_FEE + 3000 * config::mist_per_sui() + BIDDING_FEE * 3, 0);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin3) == 7200 * config::mist_per_sui(), 0);
            ...
            assert!(auction::get_balance(&auction) == 0, 0);
            assert!(
                suins::balance(&suins) == START_AN_AUCTION_FEE + 3000 * config::mist_per_sui() + BIDDING_FEE * 3,
                0
            );
    ...
    fun test_finalize_all_auctions_by_admin_not_affect_non_winning_bids_2() {
        ...
        let seal_bid = make_seal_bid(FIRST_DOMAIN_NAME, SECOND_USER_ADDRESS, 2000 * config::mist_per_sui(), FIRST_SECRET);
        place_bid_util(scenario, seal_bid, 12200 * config::mist_per_sui(), SECOND_USER_ADDRESS, 0, option::some(FIRST_TX_HASH), 20);
        ...
        test_scenario::next_tx(scenario, SUINS_ADDRESS);
        {
            ...
            get_entry_util(&mut auction,
                FIRST_DOMAIN_NAME, START_AN_AUCTION_AT + 1, 2000 * config::mist_per_sui(), 1000 * config::mist_per_sui(), SECOND_USER_ADDRESS, true);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&second_coin) == 11200 * config::mist_per_sui(), 0);

            assert!(auction::get_balance(&auction) == 1300 * config::mist_per_sui(), 0);
            assert!(suins::balance(&suins) == START_AN_AUCTION_FEE + 950 * config::mist_per_sui() + BIDDING_FEE * 2, 0);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            let coin2 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin2) == 50 * config::mist_per_sui(), 0);
            let coin3 = test_scenario::take_from_address<Coin<SUI>>(scenario, SECOND_USER_ADDRESS);
            assert!(coin::value(&coin3) == 11200 * config::mist_per_sui(), 0);
            ...
            assert!(auction::get_balance(&auction) == 0, 0);
            assert!(
                suins::balance(&suins) == START_AN_AUCTION_FEE + 950 * config::mist_per_sui() + BIDDING_FEE * 2,
                0
            );
    ...
    fun test_bids_multiple_times_same_domain_and_same_highest_value_then_finalize_all_auctions_by_admin() {
        ...
        place_bid_util(scenario, seal_bid, 12200 * config::mist_per_sui(), FIRST_USER_ADDRESS, 0, option::some(FIRST_TX_HASH), 20);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            let coin1 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin1) == 100 * config::mist_per_sui(), 0);
            let coin2 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin2) == 1300 * config::mist_per_sui(), 0);

            assert!(auction::get_balance(&auction) == 12200 * config::mist_per_sui(), 0);
            assert!(suins::balance(&suins) == START_AN_AUCTION_FEE + 1900 * config::mist_per_sui() + BIDDING_FEE * 2, 0);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin2) == 1300 * config::mist_per_sui(), 0);
            let coin3 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin3) == 100 * config::mist_per_sui(), 0);
    ...
    fun test_bids_multiple_times_same_domain_and_same_highest_value_then_finalize_all_auctions_by_admin_2() {
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin1) == 100 * config::mist_per_sui(), 0);
            let coin2 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin2) == 10200 * config::mist_per_sui(), 0);
    ...
    #[test]
        ...
        test_scenario::next_tx(scenario, SUINS_ADDRESS);
        {
            ...
            get_entry_util(&mut auction,
                FIRST_DOMAIN_NAME, START_AN_AUCTION_AT + 1, 2000 * config::mist_per_sui(), 1000 * config::mist_per_sui(), FIRST_USER_ADDRESS, false);
            finalize_all_auctions_by_admin(
                &admin_cap,
                &mut auction,
                &mut suins,
            ...
            get_entry_util(&mut auction,
                FIRST_DOMAIN_NAME, START_AN_AUCTION_AT + 1, 2000 * config::mist_per_sui(), 1000 * config::mist_per_sui(), FIRST_USER_ADDRESS, true);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            let coin1 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin1) == 50 * config::mist_per_sui(), 0);
            let coin2 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin2) == 11200 * config::mist_per_sui(), 0);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(coin::value(&coin2) == 11200 * config::mist_per_sui(), 0);
            let coin3 = test_scenario::take_from_address<Coin<SUI>>(scenario, FIRST_USER_ADDRESS);
            assert!(coin::value(&coin3) == 50 * config::mist_per_sui(), 0);
    ...
    fun test_set_bidding_fee_works() {
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(auction::get_balance(&auction_house) == 1300 * config::mist_per_sui(), 0);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            let auction = test_scenario::take_shared<AuctionHouse>(scenario);
            let suins = test_scenario::take_shared<SuiNS>(scenario);
            let coin = coin::mint_for_testing<SUI>(new_bidding_fee * 3 + 1200 * config::mist_per_sui(), ctx);
            let clock = test_scenario::take_shared<Clock>(scenario);

            auction::place_bid(&mut auction, &mut suins, seal_bid, 1200 * config::mist_per_sui(), &mut coin, &clock, ctx);
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(auction::get_balance(&auction_house) == 2500 * config::mist_per_sui(), 0);
    ...
    fun test_set_bidding_fee_works_2() {
        ...
        test_scenario::next_tx(scenario, FIRST_USER_ADDRESS);
        {
            ...
            assert!(auction::get_balance(&auction_house) == 1200 * config::mist_per_sui(), 0);
