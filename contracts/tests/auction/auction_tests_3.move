...
module suins::auction_tests_3 {
    ...
    use std::vector;
    use std::option;
    use suins::auction_tests::{test_init, start_an_auction_util, place_bid_util, reveal_bid_util, ctx_new, state_util, get_bid_util, ctx_util, finalize_auction_util, get_entry_util};
