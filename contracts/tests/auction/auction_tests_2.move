...
module suins::auction_tests_2 {
    ...
    use suins::auction::{Self, make_seal_bid, get_bids_by_bidder, get_bid_detail_fields, withdraw, state, AuctionHouse, finalize_auction_by_admin, finalize_all_auctions_by_admin};
    use suins::configuration::Configuration;
    use std::vector;
    use std::option;
    use suins::auction_tests::{test_init, start_an_auction_util, place_bid_util, reveal_bid_util, get_entry_util, finalize_auction_util, ctx_new, state_util, get_bid_util, ctx_util};
