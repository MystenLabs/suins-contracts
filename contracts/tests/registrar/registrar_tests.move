...
module suins::registrar_tests {
    ...
    fun test_new_reserved_domains() {
        ...
        test_scenario::next_tx(&mut scenario, SUINS_ADDRESS);
        {
            ...
            registrar::new_reserved_domains(&admin_cap, &mut suins, &config, b"abcdefghijk.move", @0x0B, ctx);
    ...
    fun test_new_reserved_domains_aborts_with_dupdated_domain_names() {
        ...
        test_scenario::next_tx(&mut scenario, SUINS_ADDRESS);
        {
            ...
            registrar::new_reserved_domains(&admin_cap, &mut suins, &config, b"abcde.sui;abcde.sui;", @0x0, ctx);
    ...
    fun test_new_reserved_domains_aborts_with_malformed_domains() {
        ...
        test_scenario::next_tx(&mut scenario, SUINS_ADDRESS);
        {
            ...
            registrar::new_reserved_domains(&admin_cap, &mut suins, &config, b"abcde..sui;", @0x0, ctx);
    ...
    fun test_new_reserved_domains_aborts_with_non_existence_tld() {
        ...
        test_scenario::next_tx(&mut scenario, SUINS_ADDRESS);
        {
            ...
            registrar::new_reserved_domains(&admin_cap, &mut suins, &config, b"abcde.suins;", @0x0, ctx);
