...
module suins::remove_later {
    ...
    public(friend) fun deserialize_image_msg(msg: vector<u8>): (String, String, u64, String) {
        ...
        (ipfs, domain_name, converter::string_to_number(expiry), msg)
    }
