...
use sui::event::emit;
use suins_voting::{constants::{day_ms, month_ms}, staking_admin::StakingAdminCap};
...
fun init(_otw: STAKING_CONFIG, ctx: &mut TxContext) {
...
public fun set_max_lock_months(
...
public fun set_monthly_boost_bps(
    config: &mut StakingConfig,
    _: &StakingAdminCap,
    monthly_boost_bps: u64,
) {
...
fun emit_event(property: vector<u8>, old_value: u64, new_value: u64) {
