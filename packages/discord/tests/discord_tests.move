...
use coupons::setup as coupon_setup;
use discord::discord::{Self, Discord, DiscordCap, DiscordApp};
use discord::test_payloads as tp;
...
fun test_init(): Scenario {
    ...
    coupon_setup::initialize_coupon_house(scenario);
    {
        ...
        cap.add_discord_role(
            &mut discord,
            tp::get_nth_role(0),
            tp::get_nth_role_percentage(0),
        );
        cap.add_discord_role(
            &mut discord,
            tp::get_nth_role(1),
            tp::get_nth_role_percentage(1),
        );
        cap.add_discord_role(
            &mut discord,
            tp::get_nth_role(2),
            tp::get_nth_role_percentage(2),
        );
        cap.add_discord_role(
            &mut discord,
            tp::get_nth_role(3),
            tp::get_nth_role_percentage(3),
        );
        cap.add_discord_role(
            &mut discord,
            tp::get_nth_role(4),
            tp::get_nth_role_percentage(4),
        );
