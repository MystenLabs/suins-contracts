...
#[test_only]
module suins_bbb::payments_tests;
...
public fun setup(ctx: &mut TxContext): (SuiNS, AdminCap) {
    ...
    suins_bbb::testusdc::test_init(ctx);
    suins_bbb::testns::test_init(ctx);

    (suins, admin_cap)
}

#[test, expected_failure(abort_code = ::suins_bbb::payments::EBaseCurrencySetupMissing)]
...
#[test, expected_failure(abort_code = ::suins_bbb::payments::EInsufficientPayment)]
...
#[test, expected_failure(abort_code = ::suins_bbb::payments::EInvalidPaymentType)]
