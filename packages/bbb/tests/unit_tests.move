...
module suins_bbb::unit_tests;

use suins_bbb::payments::calculate_target_currency_amount;
...
#[test, expected_failure(abort_code = ::suins_bbb::payments::EInvalidPythPrice)]
