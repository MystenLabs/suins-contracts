...
(async () => {
	...
	// console.log('Domain Record: ', await suinsClient.getNameRecord('tony.testing12345.sui'));
	...
	// suinsTx.extendSubNameExpiration({
	// 	nft: '0x8d4af9dc54023182ae8ca78717587f4d99b10458821fc94be7716681f164507b',
