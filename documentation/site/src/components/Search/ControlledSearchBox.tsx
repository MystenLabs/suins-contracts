...
export default function ControlledSearchBox({
  ...
  return (
    <div className="flex items-center mb-8 border border-suins-gray-40 dark:border-suins-gray-70 rounded-lg bg-suins-gray-10 dark:bg-suins-white-80 pl-2">
      {searchSvg}
      <input
        ref={inputRef}
        type="search"
        className="cursor-pointer w-full py-2 pr-4 h-[40px] text-lg border-transparent bg-transparent focus-visible:outline-none dark:text-suins-gray-50 dark:placeholder-suins-gray-50"
