...
const pageItemStyle =
  "px-3 py-[9px] border border-solid border-suins-gray-50 dark:border-suins-white-50 hover:!border-suins-green cursor-pointer rounded-md text-sm text-suins-grey-80 dark:text-suins-green-dark dark:hover:border-suins-link";
const disabledItemStyle =
  "px-3 py-[9px] opacity-50 cursor-not-allowed border border-solid border-suins-gray-50 rounded-md";
        ...
        return (
          <li
            ...
            className={`${pageItemStyle} ${
              isActive
                ? "bg-suins-gray-10 dark:bg-suins-white-30 dark:!text-suins-white-100"
                : ""
            }`}
          >
            {page + 1}
