                  ...
                  <div key={i} className="mb-2">
                    {isInternal ? (
                      <button
                        ...
                        className="text-base text-blue-600 hover:text-suins-green-dark underline text-left bg-transparent border-0 pl-0 cursor-pointer font-[Inter]"
                      >
                        {sectionTitle}
                      </button>
                    ) : (
                      <a
                        ...
                        className="text-base text-suins-link underline pb-2"
                      >
                        {sectionTitle}
                      </a>
                    )}
                    <p
                      className="font-normal text-base text-suins-gray-50 dark:text-suins-white-80"
                      dangerouslySetInnerHTML={{
                        __html: hit.content
