...
--move-call @mvr/metadata::package_info::transfer packageinfo @<Address to transfer packageInfo>
```
...
--move-call @mvr/metadata::package_info::set_git_versioning @<Your PackageInfo object> <Version number> git
```
...
```bash
sui client transfer --to <address to transfer> --object-id <packageInfo>
```
