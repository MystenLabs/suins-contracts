...
Sui Name Service documentation details how to integrate Sui Name Service (SuiNS) with your projects. This includes ways to integrate using both the on-chain and off-chain resolutions, depending on the use case.
