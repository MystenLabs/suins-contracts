...
Full nodes for the Mainnet environment process SuiNS names without additional configuration. The Mysten Labs public RPC nodes for Testnet also process SuiNS names. 

Mysten Labs public RPC nodes.
