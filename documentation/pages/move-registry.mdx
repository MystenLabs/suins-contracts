...
- The Sui SDK repository houses the [MVR plugin for Sui TypeScript SDK](https://github.com/MystenLabs/ts-sdks/tree/main/packages/typescript/src/transactions/plugins/NamedPackagesPlugin.ts) and [MVR static tool](https://github.com/MystenLabs/ts-sdks/tree/main/packages/mvr-static)
